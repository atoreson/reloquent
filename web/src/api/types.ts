...
export const ALL_STEPS: StepInfo[] = [
  ...
  { id: "table_selection", label: "Table Selection", order: 2 },
  { id: "denormalization", label: "Denormalization Design", order: 3 },
  { id: "type_mapping", label: "Type Mapping", order: 4 },
  { id: "sizing", label: "Sizing", order: 5 },
  { id: "review", label: "Review", order: 6 },
  { id: "target_connection", label: "Target Connection", order: 7 },
  { id: "aws_setup", label: "AWS Setup", order: 8 },
  { id: "pre_migration", label: "Pre-Migration", order: 9 },
